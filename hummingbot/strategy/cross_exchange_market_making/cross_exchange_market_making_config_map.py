...
cross_exchange_market_making_config_map = {
    ...
    "limit_order_min_expiration": ConfigVar(
        ...
        prompt="limit_order_min_expiration",
        default=130.0,
        type_str="float",
        required_if=lambda: False,
    ),
    ...
    "anti_hysteresis_duration": ConfigVar(
        ...
        prompt="anti_hysteresis_duration",
        default=60,
        type_str="float",
        required_if=lambda: False,
    ),
    "order_size_taker_volume_factor": ConfigVar(
        ...
        prompt="order_size_taker_volume_factor",
        default=0.25,
        type_str="decimal",
        required_if=lambda: False,
    ),
    "order_size_taker_balance_factor": ConfigVar(
        ...
        prompt="order_size_taker_balance_factor",
        default=0.995,
        type_str="decimal",
        required_if=lambda: False,
    ),
    "order_size_portfolio_ratio_limit": ConfigVar(
        ...
        prompt="order_size_portfolio_ratio_limit",
        default=0.1667,
        type_str="decimal",
        required_if=lambda: False,
    )

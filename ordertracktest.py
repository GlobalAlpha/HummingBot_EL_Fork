...
class HuobiJapanOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[HuobiJapanOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: HuobiJapanOrderBookTracker = HuobiJapanOrderBookTracker(
    ...
    def test_order_book_trade_event_emission(self):
        ...
        """
        print("test_order_book_trade_event_emission")
    ...
    def test_tracker_integrity(self):
        ...
        btcusdt_book: OrderBook = order_books["btcjpy"]
        xrpusdt_book: OrderBook = order_books["bchbtc"]
        ...
        self.assertGreaterEqual(xrpusdt_book.get_price_for_volume(True, 10).result_price,
                                xrpusdt_book.get_price(True))
        self.assertLessEqual(xrpusdt_book.get_price_for_volume(False, 10).result_price,
